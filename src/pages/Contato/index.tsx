                ...
                <main className="main_cadastroUsuario">
                    <div className="container container_cad">
                        <div className="contato_conteudo">
                            <h1>Contato</h1>
                            <hr />
                            <form className="contato_formulario" method="POST" onSubmit={cadastrarUsuario}>
                            ...
                            />
                                ...
                                <div className="input">
                                    <img className="form-label" src="../Cadastro/imagens/icon User.png">
                                        <div className="input-select">
                                            <label for="select">Motivo</label>

                                            <select name="Motivo do Contato">
                                                <option value="valor1">Reclamações</option>
                                                <option value="valor2" selected>Dúvidas</option>
                                ...
                                <form>
                                    <label>Mensagem:</label><br><textarea class="msg" cols="35" rows="8"
                                        placeholder="Insira seu texto"></textarea><br>
                                </form>
